...
//            sdb.batchPutAttributes(new BatchPutAttributesRequest(myDomain, createSampleData()));
            ...
            selectExpression = "select * from `" + myDomain + "` where ItemName() = 'Item_16'";
            System.out.println("Selecting: " + selectExpression + "\n");
            SelectRequest selectRequest = new SelectRequest(selectExpression);
            Utils.showItemList(sdb.select(selectRequest).getItems());
            

            selectExpression = "select * from `" + myDomain + "` where ItemName() like 'Item%'";
            System.out.println("Selecting: " + selectExpression + "\n");
